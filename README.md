...
it allows us to write code that will change frequently without having to write a lot
...
Side effects are anything that affects something outside the current function. You can sync using useEffect hook
